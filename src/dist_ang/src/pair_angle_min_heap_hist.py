...
class ClosestPairAngleCalculator:
    def __init__(self):
        ...
        self.threshold = 0.16
        self.min_radial_distance = 0.1  # Minimum radial distance to search for closest points
        self.max_radial_distance = 2.0  # Maximum radial distance
    ...
    def point_cloud_callback(self, msg):
        ...
        for point in points:
            ...
            if self.min_radial_distance <= math.sqrt(-distance) <= self.max_radial_distance:
